...
public class ReportOpinionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrowBtn = findViewById(R.id.arrow_btn_report_opinion);
        edReport = findViewById(R.id.ed_report_opinion);
        username = findViewById(R.id.username_report_opinion);
        sendBtn = findViewById(R.id.report_btn_opinion);
        coordinatorLayout = findViewById(R.id.coordinator_report_opinion);

        toolbar = findViewById(R.id.toolbar_report_opinion);
        ...
        reportRef = FirebaseDatabase.getInstance().getReference().child("Report Opinions");
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ReportOpinionActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
            ...
            if (TextUtils.isEmpty(value)){
                ...
                reportRef.child(reportId).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(ReportOpinionActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void removeReport(String reportId) {
        ...
        Toast.makeText(ReportOpinionActivity.this, remove, Toast.LENGTH_SHORT).show();
    }
}